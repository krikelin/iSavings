...
@interface INPlanTableViewController ()

@end

@implementation INPlanTableViewController
@synthesize account;
...
- (NSString *)tableView:(UITableView *)tableView titleForHeaderInSection:(NSInteger)section {
    INYearAccount *year = [[[self account] years] objectAtIndex:section];
    return [NSString stringWithFormat:@"%d", [year year], nil];
}
- (NSInteger)numberOfSectionsInTableView:(UITableView *)tableView
{
#warning Potentially incomplete method implementation.
    // Return the number of sections.
    return [[[self account] years] count];
}
...
#warning Incomplete method implementation.
    ...
    INYearAccount *year = (INYearAccount *)[[[self account] years] objectAtIndex:section];
    return [[year transactions] count];
}
